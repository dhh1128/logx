...
# TODO: remove this func on about sep 15 2011; had to add it to make sadm's
# auto-update function work. Long story. --Daniel
def write_if_changed(path, txt, encoding='utf-8', compare_func=text_diff.texts_differ):
    write_if_different(path, txt, encoding, compare_func)
